...
// Complete categories data - ALL 38 CATEGORIES
...
export default function Home() {
  ...
  const handleMainSearch = async (e: React.FormEvent) => {
    ...
    // Simulate API call for main search
    setTimeout(() => {
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              <div className="h-8 w-32 bg-gradient-to-r from-blue-600 to-purple-600 rounded flex items-center justify-center">
                <span className="text-white font-bold text-lg">CamRove</span>
              </div>
            </div>
                        ...
                        <div className="p-3">
                          ...
                          <div className="pl-9 space-y-1">
                            {category.subcategories.map((sub) => (
                              <div key={sub} className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer py-1">
                                {sub}
                              </div>
                            ))}
                          </div>
                            ...
                            {categories.map((category) => (
                              <div key={category.id} className="border border-gray-100 dark:border-gray-600 rounded-lg p-3">
                                ...
                                <div className="space-y-1">
                                  {category.subcategories.map((sub) => (
                                    <div key={sub} className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer py-1 pl-2">
                                      {sub}
                                    </div>
                                  ))}
                                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4 flex items-center">
                <div className="h-6 w-24 bg-gradient-to-r from-blue-600 to-purple-600 rounded flex items-center justify-center mr-2">
                  <span className="text-white text-sm font-bold">CamRove</span>
                </div>
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={toggleSidebar} className="hover:text-white transition-colors">All Categories</button></li>
                <li><a href="#" className="hover:text-white transition-colors">Featured Professionals</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Create Portfolio</a></li>
